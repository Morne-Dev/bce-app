<template>
  ...
  >
    ...
    >
      ...
      <!-- Right content -->
      <div
        class="w-full md:w-1/2 text-white max-w-2xl mx-auto text-left space-y-5 animate-item"
      >
    ...
    <!-- Features Section -->
    <div
      class="relative z-10 mt-24 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-10 text-center md:text-left"
    >
      <div class="animate-item flex flex-col items-center sm:items-start">
        <div class="bg-white shadow-md p-4 rounded-full">
          <BuildingOfficeIcon class="h-10 w-10 text-yellow-600" />
        </div>
      ...
      <div class="animate-item flex flex-col items-center sm:items-start">
        <div class="bg-white shadow-md p-4 rounded-full">
          <StarIcon class="h-10 w-10 text-yellow-600" />
        </div>
      ...
      <div class="animate-item flex flex-col items-center sm:items-start">
        <div class="bg-white shadow-md p-4 rounded-full">
          <MapPinIcon class="h-10 w-10 text-yellow-600" />
        </div>
