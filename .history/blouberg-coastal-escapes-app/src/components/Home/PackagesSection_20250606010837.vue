<template>
  <section class="relative py-28 px-6 sm:px-10 bg-gradient-to-br from-white via-[#f3fafa] to-[#eaf3f3] overflow-hidden">
    <div class="max-w-7xl mx-auto">
      ...
      <!-- Interactive 3D Carousel of 4 Cards -->
      <div
        ref="carousel"
      ...
      >
        <div
          ...
          :key="idx"
          class="flex-shrink-0 w-[280px] scroll-snap-start"
...
const cards = reactive([
  {
    ...
    description: 'Ideal for property owners who want us to handle everything—from bookings and inquiries to maintenance.',
    features: ['Booking & Inquiries Management','Guest Welcome & Key Handover','Property Inspection & Maintenance','Basic Amenities & Stocking','Basic Repairs & Support'],
    pricing: 'Commission: 20% of booking fee',
    addOns: ['Special Occasion Setup (from R600)','Mid-Stay Cleaning (from R300)','Laundry Service'],
    cta: 'Get Started', expanded: false
  },
  {
    title: 'Premium Care Package',
    description: 'Fully managed experience with VIP services, luxury amenities, cleaning, and maintenance.',
    features: ['Full Booking & Inquiry Management','Guest Welcome & VIP Check-in','Professional Cleaning After Check-out','Laundry Service','High-End Amenities & Welcome Pack','Basic & Minor Maintenance'],
  ...
  },
  {
    ...
    description: 'Thorough professional cleaning for your property between stays or on-demand.',
    features: ['Standard Cleaning: From R460/session','Hot Tub Cleaning: From R150','Fridge Defrost & Essentials Restock','Personalized Guest Setup'],
    pricing: 'Book Cleaning',
    addOns: [],
    cta: 'Book Cleaning', expanded: false
  },
  {
    title: 'Maintenance Services',
    description: 'Keep your property running smoothly with repairs and urgent fixes.',
    features: ['Basic Maintenance: From R350/call','Emergency Maintenance: From R600','Monthly Package: From R1000/mo'],
    pricing: 'Book Maintenance',
    addOns: [],
    cta: 'Book Maintenance', expanded: false
  }
]);
