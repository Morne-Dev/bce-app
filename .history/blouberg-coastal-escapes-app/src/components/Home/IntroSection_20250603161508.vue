  ...
  >
    ...
    >
      <div class="flex-1 animate-item flex flex-col items-center">
        <div class="backdrop-blur-sm bg-white/70 p-4 rounded-full shadow-md hover:bg-white/90 transition">
          <BuildingOfficeIcon class="h-10 w-10 text-gray-800" />
        </div>
        <h3 class="font-semibold italic text-gray-800 mt-3">Established</h3>
      ...
      <div class="flex-1 animate-item flex flex-col items-center">
        ...
        <h3 class="font-semibold italic text-gray-800 mt-3">Reviews</h3>
        <p class="text-sm text-gray-600 mt-2">
      ...
      <div class="flex-1 animate-item flex flex-col items-center">
        ...
        <h3 class="font-semibold italic text-gray-800 mt-3">Local</h3>
        <p class="text-sm text-gray-600 mt-2">
