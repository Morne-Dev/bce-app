<template>
  ...
  >
    ...
    <div class="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-black/30 via-transparent to-transparent z-0"></div>

    <!-- Bottom White Fade -->
    <div class="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-white to-transparent z-0"></div>
