<template>
  ...
  >
    ...
    <!-- Top Content -->
    <div class="relative z-10 max-w-6xl mx-auto flex flex-col justify-end md:flex-row items-center justify-between md:gap-12 px-6 sm:px-8">
      <!-- Left image -->
    ...
    <div class="relative z-10 mt-20 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-y-16 sm:gap-12 text-center">
      <div class="animate-item flex flex-col items-center" style="transition-delay: 0.1s;">
        ...
        <p class="mt-2 text-sm text-neutral-600">
          As Blouberg locals, we have an in-depth understanding of the holiday market in the area. Our firsthand knowledge allows us to provide tailored holiday property management solutions, ensuring your investment is well-maintained and optimized for success.
        </p>
      </div>
      ...
      <div class="animate-item flex flex-col items-center" style="transition-delay: 0.2s;">
        ...
        <p class="mt-2 text-sm text-neutral-600">
          Consistently rated above industry standard, our high review score shows our commitment to guest experience. This dedication ensures exceptional satisfaction, fostering repeat visits and positive referrals, which directly enhance your property's reputation and profitability.
        </p>
      </div>
      ...
      <div class="animate-item flex flex-col items-center" style="transition-delay: 0.3s;">
        ...
        <p class="mt-2 text-sm text-neutral-600">
          Based in Blouberg, we’re proud locals with unmatched expertise in property management services. Our in-depth knowledge of Blouberg’s holiday rental market ensures reliable solutions for short-term stays and property management. Serving homeowners and investors, we blend community insights with personalized service.
        </p>
      </div>
    </div>

    <!-- Bottom Fade to White -->
    <div class="absolute inset-x-0 bottom-0 h-[95vh] bg-gradient-to-t from-[#fefefe] via-[#ffffffcc] to-transparent z-0"></div>
  </section>
</template>
