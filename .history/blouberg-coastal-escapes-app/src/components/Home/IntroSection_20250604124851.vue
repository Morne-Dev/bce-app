<template>
  ...
  >
    ...
    >
      ...
      <!-- Right content -->
      <div
        class="w-full md:w-1/2 text-white max-w-2xl mx-auto text-center md:text-left space-y-6"
      >
        <h1 class="text-4xl sm:text-5xl font-serif font-semibold text-black leading-tight animate-item">
    ...
    <div class="absolute inset-x-0 bottom-0 h-[90vh] bg-gradient-to-t from-white via-white/90 to-transparent z-0"></div>
  </section>
</template>
