<template>
  <section
    class="relative min-h-screen w-full bg-cover bg-center px-6 py-20 sm:py-24 fade-top"
  ...
  >
    ...
    <!-- Gradient Overlay (kept for a bit of visual richness) -->
    <div class="absolute inset-0 bg-gradient-to-b from-black/30 via-transparent to-white/70 z-0"></div>

    <!-- Top Content -->
    <div class="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between pt-32">
      <!-- Left image -->
      ...
      <!-- Right content -->
      <div class="w-full md:w-1/2 max-w-2xl mx-auto text-center md:text-left space-y-4 text-black">
        <h1 class="text-3xl sm:text-4xl md:text-5xl font-serif font-semibold leading-tight animate-item">
