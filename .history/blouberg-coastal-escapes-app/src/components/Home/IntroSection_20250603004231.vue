<template>
  ...
  >
    ...
    <v-motion
      ...
      :enter="{ opacity: 1, y: 0, transition: { duration: 1.5, delay: 0.3 } }"
      class="relative z-10 w-full flex flex-col md:flex-row md:items-center md:justify-between max-w-6xl mx-auto"
    >
