<template>
  ...
  >
    ...
    >
      <div class="flex-1 animate-item flex flex-col items-center">
        <div class="bg-gray-100 p-3 rounded-full hover:bg-gray-200">
          <BuildingOfficeIcon class="h-10 w-10 text-gray-700" />
        </div>
        <h3 class="font-semibold italic text-gray-800 mt-2">Established</h3>
      ...
      <div class="flex-1 animate-item flex flex-col items-center">
        <div class="bg-gray-100 p-3 rounded-full hover:bg-gray-200">
          <StarIcon class="h-10 w-10 text-gray-700" />
        </div>
        <h3 class="font-semibold italic text-gray-800 mt-2">Reviews</h3>
        <p class="text-sm text-gray-600 mt-2">
      ...
      <div class="flex-1 animate-item flex flex-col items-center">
        <div class="bg-gray-100 p-3 rounded-full hover:bg-gray-200">
          <MapPinIcon class="h-10 w-10 text-gray-700" />
        </div>
        <h3 class="font-semibold italic text-gray-800 mt-2">Local</h3>
        <p class="text-sm text-gray-600 mt-2">
