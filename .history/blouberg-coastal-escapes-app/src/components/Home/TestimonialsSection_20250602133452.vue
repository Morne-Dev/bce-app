<template>
  <section class="relative py-20 px-6 bg-gray-50">
    <!-- Watermark Background -->
    <div class="absolute inset-0 opacity-5">
      <div class="h-full w-full pattern-wavy-pattern pattern-gray-300 pattern-opacity-100 pattern-size-16"></div>
    </div>
    
    <div class="relative max-w-7xl mx-auto">
      <!-- Section Header -->
      <div class="text-center mb-16">
        <h2 class="text-4xl font-bold text-gray-800 mb-1">Guest Testimonials</h2>
        <div class="w-24 h-1 bg-blue-500 mx-auto mb-6"></div>
        <p class="text-xl text-gray-600 max-w-3xl mx-auto">
          Hear from property owners who trust us with their investments
        </p>
      </div>
...
.pattern-wavy-pattern {
  background-image: url("data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h100v100H0z' fill='none'/%3E%3Cpath d='M0 20c10 0 20-10 30-10s20 10 30 10 20-10 30-10 20 10 30 10 20-10 30-10v60c-10 0-20 10-30 10s-20-10-30-10-20 10-30 10-20-10-30-10-20 10-30 10V20z' fill='%23000' fill-opacity='0.1'/%3E%3C/svg%3E");
}
</style>